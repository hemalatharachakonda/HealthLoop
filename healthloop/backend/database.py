...
Examples:
  ...
  MySQL:
    DATABASE_URL=mysql+pymysql://username:password@localhost:3306/healthloop
...
# SQLite needs this extra arg for use with FastAPI's threaded requests; Postgres/MySQL don't.
